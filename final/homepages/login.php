<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if(!filter_var($myusername, FILTER_VALIDATE_EMAIL)){
      	...
      	echo "<div style='text-align:center'> <font color=brown size='4pt'>Invalid Email Address </font> </div>";
      }
      else{

      $sql = "SELECT mail_id , user_type FROM custInfo WHERE mail_id = '$myusername' and password = '$mypassword'";
