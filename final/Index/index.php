    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 > CityCabs </h1>
                <h2> A cab experience u can never forget </h2>
                <p> Book a cab or Taxi at cheap prices across the city. </p>
                <a href="../homepages/login.php" class="btn btn-primary btn-lg">Ride Now</a>
            </div>
        </div>
    </header>
    ...
    <footer class="page-footer">
        ...
        <div class="contact">
        	<div class="container">
				...
				<p><span class="glyphicon glyphicon-envelope"></span><br> enquiry@citycabs.com </p>
        	</div>
        </div>
